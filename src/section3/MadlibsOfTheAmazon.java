...
String adjective = JOptionPane.showInputDialog("Enter a Adjective, NOW!");
		// Get the user to enter a type of liquid
String liquid = JOptionPane.showInputDialog("Enter a type of Liquid, NOW!");
		// Get the user to enter a body part
String bodypart = JOptionPane.showInputDialog("Enter a Body Part, NOW!");
